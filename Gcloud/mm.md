# User Authentication: Identity-Aware Proxy || [GSP499](https://www.skills.google/games/7394/labs/45376)
...
```bash
curl -LO https://raw.githubusercontent.com/manavyugai/Cloud-Monitoring/main/Gcloud/AWARE.sh
sudo chmod +x AWARE.sh
./AWARE.sh
```
